	...
	<view class="mod">
		...
		<view class="mod">
			...
			<view class="bd">
				...
				<br>适合清晰/简单的工作任务</p></li> <li class="item cur"><i class="icon iconfont icon-dui1"></i> <view class="icon-group cl"><i class="icon iconfont icon-16"></i> <i class="icon iconfont icon-16"></i></view> <p class="name zishen"></p>资深级<p class="desc">工作经验 3-5 年
